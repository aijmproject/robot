...
'''
subscription_key = "7312fdabc95d4f61b94408d74612f4ea"
...
class TextToSpeech(object):
    ...
    def save_audio(self):
        ...
        voice.set('name', 'Microsoft Server Speech Text to Speech Voice (fr-FR, Julie, Apollo)') # Short name for 'Microsoft Server Speech Text to Speech Voice (en-US, Guy24KRUS)'
        voice.text = self.tts
